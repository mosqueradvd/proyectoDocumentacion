...
const rows = [
  createData(1, "Lennin Ibarra", "udenar"),
  createData(2, "Valentina Martinez", "Montaña de Fuego"),
  createData(3, "Deisy Rosero", "Tierra de todos"),
  createData(4, "Marta Melo", "Modep"),
];
...
const headCells = [
  ...
  { id: "names", numeric: false, label: "Representante legal" },
...
export default function ComponentListOrganizations() {
