...
const ComponentModifyOrganization = () => {
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={6}>
              <TextField
                ...
                variant="outlined"
                fullWidth
                defaultValue={user.organizacion}
              />
            </Grid>
...
export default ComponentModifyOrganization;
